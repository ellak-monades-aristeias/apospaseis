    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
              ...
              </p><p class='small'><a href="https://github.com/ellak-monades-aristeias/apospaseis/tree/master/deliverable2"><strong>Π2</strong> Βάση δεδομένων με τις αποσπάσεις τεσσάρων (4) παλαιότερων σχολικών ετών</a>
              </p><p class='small'><a href="https://github.com/ellak-monades-aristeias/apospaseis/tree/master/deliverable3"><strong>Π3</strong> Υπηρεσία: Κώδικας της βασικής υπηρεσίας (web site και μηχανισμοί τροφοδότησης της ΒΔ με δεδομένα αποσπάσεων)</a>
              </p><p class='small'><a href="https://github.com/ellak-monades-aristeias/apospaseis/tree/master/deliverable4"><strong>Π4</strong> API: Κώδικας API με την κατάλληλη τεκμηρίωση και οδηγίες χρήσης του API</a>
              </p><p class='small'><a href="https://github.com/ellak-monades-aristeias/apospaseis/tree/master/deliverable5"><strong>Π5</strong> Εργασία που πρόκείται να υποβληθεί προς κρίση σε συνέδριο. Η εργασία θα αφορά την παρουσίαση του έργου</a>
              </p>
