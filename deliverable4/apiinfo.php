        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <p>		
					<small>				
					Το @pospaseis προσφέρει μια διεπαφή προγραμματισμού εφαρμογής (Application Programming Interface-API) που παρέχει έναν εύχρηστο 
					τρόπο ανάκτησης των αποτελεσμάτων μιας αναζήτησης σε μορφή <a href=https://en.wikipedia.org/wiki/JSON>JSON</a>. 
					...
					η χρήση του API είναι ιδιαίτερα απλή: Αρχεί να κάνετε ένα αίτημα http στο script που βρίσκεται στη διεύθυνση:</p>
					...
					<br><strong>am: </strong> (Προαιρετική): Επιτρέπει την αναζήτηση βάσει του αρισθμού μητρώου του εκπαιδευτικού
